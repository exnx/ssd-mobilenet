# USAGE
# python real_time_object_detection_grid_webcam.py --prototxt MobileNetSSD_deploy.prototxt.txt --model MobileNetSSD_deploy.caffemodel
...
# to have a maximum width of 400 pixels
    ...
    orig = vs.read()
    # orig = imutils.resize(orig, width=1000)
